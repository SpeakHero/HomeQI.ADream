...
namespace HomeQI.Adream.Identity
{
    ...
    public class SecurityStampValidator<TUser> : ISecurityStampValidator where TUser : ADream.Entities.Framework.EntityBase<string>
    {
        /// <summary>
    ...
    public static class SecurityStampValidator
    {
        ...
        public static Task ValidateAsync<TValidator>(CookieValidatePrincipalContext context) where TValidator : ISecurityStampValidator
        {
            ...
            {
                throw new InvalidOperationEx("RequestServices is null.");
            }
