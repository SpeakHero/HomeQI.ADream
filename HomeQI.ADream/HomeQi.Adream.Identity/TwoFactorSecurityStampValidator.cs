...
namespace HomeQI.Adream.Identity
{
    ...
    public class TwoFactorSecurityStampValidator<TUser> : SecurityStampValidator<TUser>, ITwoFactorSecurityStampValidator where TUser : ADream.Entities.Framework.EntityBase<string>
    {
        /// <summary>
