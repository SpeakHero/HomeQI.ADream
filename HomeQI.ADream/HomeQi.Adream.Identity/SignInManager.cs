...
namespace HomeQI.Adream.Identity
{
    ...
    public class SignInManager<TUser> where TUser : ADream.Entities.Framework.EntityBase<string>
    {
            ...
            IAuthenticationSchemeProvider schemes)
        {
            ...
            _contextAccessor = contextAccessor ?? throw new ArgumentNullEx(nameof(contextAccessor));
            ClaimsFactory = claimsFactory ?? throw new ArgumentNullEx(nameof(claimsFactory));
        ...
        public HttpContext Context
        {
            get
            {
                ...
                if (context == null)
                {
                    throw new InvalidOperationEx("HttpContext 必须不为NULL。");
                }
                return context;
            }
            set
        ...
        public virtual async Task<IdentityResult> UpdateExternalAuthenticationTokensAsync(ExternalLoginInfo externalLogin)
        {
            ...
            {
                throw new ArgumentNullEx(nameof(externalLogin));
            }
