...
namespace HomeQI.Adream.Identity
{
    ...
    public class DataProtectorTokenProvider<TUser> : IUserTwoFactorTokenProvider<TUser> where TUser : ADream.Entities.Framework.EntityBase<string>
    {
        /// <summary>
        ...
        public DataProtectorTokenProvider(IDataProtectionProvider dataProtectionProvider, IOptions<DataProtectionTokenProviderOptions> options)
        {
            ...
            {
                throw new ArgumentNullEx(nameof(dataProtectionProvider));
            }
