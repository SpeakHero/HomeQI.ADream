...
namespace HomeQI.ADream.Identity.Store
{
    ...
    /// </summary>
    public interface IUserClaimStore : IUserStore
    {
        /// <summary>
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> used to propagate notifications that the operation should be canceled.</param>
        /// <returns>
        /// A <see cref="Task{TResult}"/> that represents the result of the asynchronous query, a list of <typeparamref name="User"/> who
