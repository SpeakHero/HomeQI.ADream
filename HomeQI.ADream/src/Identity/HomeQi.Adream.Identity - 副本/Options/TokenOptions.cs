...
namespace HomeQI.ADream.Identity.Options
{
    ...
    public class TokenOptions
    {
        ...
        /// </summary>
        /// <value>
        /// The <see cref="IUserTwoFactorTokenProvider"/> used to generate tokens used in account confirmation emails.
        /// </value>
        public string EmailConfirmationTokenProvider { get; set; } = DefaultProvider;

        /// <summary>
        /// Gets or sets the <see cref="IUserTwoFactorTokenProvider"/> used to generate tokens used in password reset emails.
        /// </summary>
        /// <value>
        /// The <see cref="IUserTwoFactorTokenProvider"/> used to generate tokens used in password reset emails.
        /// </value>
