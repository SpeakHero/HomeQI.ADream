...
namespace HomeQI.ADream.Identity
{
    ...
    public class PasswordHasher : IPasswordHasher
    {
        ...
        public virtual string HashPassword(User user, string password)
        {
            ...
            return EncryptProvider.DESEncrypt(password, DescKey);
        ...
        private static string DescKey => ConfigHelper.GetJsonConfig().GetSection("Audience")["DescKey"] ?? "TThvj8G5jb6GcTFZmxVwh5Cj";
        /// <summary>
