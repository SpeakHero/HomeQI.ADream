...
namespace HomeQI.Adream.Identity.Core
{
    ...
    internal static class Resources
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("HomeQI.Adream.Identity.Core.Resources", typeof(Resources).GetTypeInfo().Assembly);
        ...
        internal static string FormatDuplicatePhone(object p0) => string.Format(CultureInfo.CurrentCulture, GetString("InvalidPhone"), p0);
        internal static string FormatDuplicate(string invalid, object p0) => string.Format(CultureInfo.CurrentCulture, GetString(invalid), p0);
