...
namespace HomeQI.Adream.Identity
{
    ...
    public class IdentityBuilder
    {
        ...
        public virtual IdentityBuilder AddTokenProvider(string providerName, Type provider)
        {
            ...
            {
                throw new InvalidOperationEx(Resources.FormatInvalidManagerType(provider.Name, "IUserTokenProvider", UserType.Name));
            }
        ...
        public virtual IdentityBuilder AddUserManager<TUserManager>() where TUserManager : EntityBase
        {
            ...
            {
                throw new InvalidOperationEx(Resources.FormatInvalidManagerType(customType.Name, "UserManager", UserType.Name));
            }
        ...
        public virtual IdentityBuilder AddRoleValidator<TRole>() where TRole : class
        {
            if (RoleType == null)
            {
                throw new InvalidOperationEx(Resources.NoRoleType);
            }
        ...
        public virtual IdentityBuilder AddRoleManager<TRoleManager>() where TRoleManager : class
        {
            ...
            {
                throw new InvalidOperationEx(Resources.FormatInvalidManagerType(customType.Name, "RoleManager", RoleType.Name));
            }
