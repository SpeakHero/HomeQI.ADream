...
namespace HomeQI.Adream.Identity
{
    ...
    /// </remarks>
    public class IdentityErrorDescriber : BaseErrorDescriber
    {
        /// <summary>
        ...
        public IdentityError InvalidPhone()
        {
            return new IdentityError
            {
                Code = nameof(InvalidPhone),
                Description = Resources.InvalidPhone
            };
        }

        public IdentityError DuplicatePhone(string phoneNumber)
        {
            return new IdentityError
            {
                Code = nameof(DuplicateEmail),
                Description = Resources.FormatDuplicatePhone(phoneNumber)
            };
        }
