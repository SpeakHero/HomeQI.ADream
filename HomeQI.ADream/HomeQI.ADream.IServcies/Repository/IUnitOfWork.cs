...
namespace HomeQI.ADream.IServcies
{
    ...
    public interface IUnitOfWork : IDisposable
    {
        ...
        T GetService<T>();
        Task<IDataReader> ExecuteReaderAsync(RawSqlString sql, params object[] parameters);
        Task<IDataReader> ExecuteReaderAsync(FormattableString sql);
        Task<object> ExecuteScalarAsync(FormattableString sql);
        Task<object> ExecuteScalarAsync(RawSqlString sql, params object[] parameters);
        Task CheckMigrationsAsync();
        /// <summary>
