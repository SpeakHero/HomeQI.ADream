...
namespace HomeQI.ADream.Services.Identity
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserClaimsPrincipalFactory{User}"/> class.
        /// </summary>
        /// <param name="userManager">The <see cref="UserServices"/> to retrieve user information from.</param>
        ...
        /// <summary>
        /// Gets the <see cref="UserManager{User}"/> for this factory.
        /// </summary>
        /// <value>
        /// The current <see cref="UserManager{User}"/> for this factory instance.
        /// </value>
        public UserServices UserManager { get; private set; }
    ...
    public class UserClaimsPrincipalFactory<User, TRole> : UserClaimsPrincipalFactory<User>
        where User : class
        where TRole : class
    {
        /// <summary>
        ...
        public UserClaimsPrincipalFactory(UserManager<User> userManager, RoleManager<TRole> roleManager, IOptions<IdentityOptions> options)
