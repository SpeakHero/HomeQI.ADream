...
{
    public class ADreamRedisCache : IDistributedCache
    {
        private CSRedis.CSRedisClient _redisClient;
        public ADreamRedisCache(CSRedis.CSRedisClient redisClient)
        {
        ...
        {
            return _redisClient.ChangDb(index);
        }
        public async Task<string> ChangDbAsync(int index)
        {
            return await _redisClient.ChangDbAsync(index);
        }
    }
}